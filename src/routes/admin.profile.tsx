...
function ProfileEditor() {
  ...
  const setMulti =
    (field: "title" | "headline" | "bio") => (lang: "hy" | "ru" | "en", value: string) => {
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="mt-8 space-y-5">
        ...
        <MultiLangInput
          label="Headline"
          values={{ hy: form.headline_hy, ru: form.headline_ru, en: form.headline_en }}
          onChange={setMulti("headline")}
        />
        <MultiLangInput
          label="Bio"
          multiline
          rows={6}
          values={{ hy: form.bio_hy, ru: form.bio_ru, en: form.bio_en }}
          onChange={setMulti("bio")}
        />
