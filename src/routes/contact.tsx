  ...
  head: () => ({
    meta: [
      { title: "Contact — Dr. Varazdat Avetisyan" },
      {
        name: "description",
        content:
          "Get in touch for AI workshops, consulting, speaking engagements, and collaborations.",
      },
      ...
      <main className="pt-24">
        <div className="mx-auto max-w-7xl px-4 pt-8">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            Available for workshops, consulting, university lectures, keynote talks, and AI strategy
            advisory.
          </p>
        </div>
        <ContactSection />
