  ...
  head: () => ({
    meta: [
      { title: "Video Courses — Dr. Varazdat Avetisyan" },
      {
        name: "description",
        content:
          "Free video lessons on AI, Data Science, Python, Machine Learning, and Prompt Engineering.",
      },
...
function Videos() {
  ...
  const playingYtId =
    playing?.youtube_id ??
    playing?.youtube_url?.match(/(?:v=|youtu\.be\/|embed\/)([a-zA-Z0-9_-]{11})/)?.[1] ??
    null;
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-32 pb-20">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">
          Free lessons on Artificial Intelligence, Data Science, Machine Learning, Python, and
          Prompt Engineering.
        </p>
