  ...
  en: {
    ...
    experience: [
      ...
      },
      {
        ...
        role: "Lecturer",
        org: "Gavar State University",
        bullets: ["AI and Machine Learning, AI Tools, AI Systems, Neural Networks"],
      },
      {
  ...
  hy: {
    ...
    pastExperience: [
      ...
      },
      {
        ...
        bullets: [
          "«Տեղեկատվական համակարգեր» (բակալավր), «Տեղեկատվական տեխնոլոգիաները բիզնեսում» (մագիստրատուրա) ՄԿԾ-ների մշակում",
        ],
      },
      {
        ...
        bullets: [
          "«ՀայԼինգվոՏեք» — «Հաշվողական լեզվաբանություն» ՄԿԾ-ի մշակում և դասախոսների վերապատրաստում",
        ],
      },
      {
  ...
  ru: {
    ...
    experience: [
      ...
      },
      {
        ...
        role: "Преподаватель",
        org: "Гаварский государственный университет",
        bullets: ["Искусственный интеллект и машинное обучение, инструменты ИИ, нейронные сети"],
      },
      {
    ...
    pastExperience: [
      ...
      },
      {
        ...
        bullets: [
          "Грант HayLingvoTech — разработка программы «Компьютерная лингвистика» и обучение преподавателей",
        ],
      },
      {
