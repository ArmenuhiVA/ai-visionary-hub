        ...
        {courses.map((c, i) => (
          ...
          >
            ...
            >
              ...
              <span
                className={`inline-block rounded-full border px-3 py-0.5 text-xs ${levelColor[c.level ?? ""] ?? "border-border"}`}
              >
              ...
              <div className="mt-6 flex items-center justify-between text-xs text-muted-foreground">
                ...
                <span className="inline-flex items-center gap-1 text-accent group-hover:translate-x-0.5 transition">
                  {t("courses.view")} <ArrowRight className="h-3.5 w-3.5" />
                </span>
              </div>
            </Link>
          </motion.div>
