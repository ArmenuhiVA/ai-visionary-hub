    ...
    <section id="contact" className="mx-auto max-w-7xl scroll-mt-20 px-4 py-24">
      <div className="grid gap-12 md:grid-cols-2">
        <div>
          ...
          <div className="mt-8 space-y-3 text-sm">
            ...
            <div className="flex gap-3 pt-3">
              <IconLink href="https://www.linkedin.com/in/varazdat-avetisyan-phd-66346650/">
                <Linkedin className="h-4 w-4" />
              </IconLink>
              {profile?.github_url && (
                <IconLink href={profile.github_url}>
                  <Github className="h-4 w-4" />
                </IconLink>
              )}
              <IconLink href="https://www.youtube.com/@varazdatavetisyan3780">
        ...
        >
          ...
          <button
            disabled={submitting}
            className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition hover:scale-105 disabled:opacity-50"
          >
